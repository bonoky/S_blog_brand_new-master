...
public class UserController {
  ...
  public ResponseEntity<ResponseDataDto> join(@RequestBody UserJoinRequestDto requestDto) {
  ...
  public ResponseEntity<ResponseDataDto> login(@RequestBody UserLoginRequestDto requestDto,
    ...
    UserLoginRequestDto userLoginResponseDto = userService.login(requestDto);
